...
import { RotateCcw, Save, Settings as SettingsIcon, SlidersHorizontal, WifiOff } from 'lucide-react'
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div className="rounded-lg border border-slate-800 bg-slate-950/50 px-3 py-3">
                <div className="text-[10px] uppercase tracking-wide text-slate-500">Offset actuel</div>
                <div className="mt-1 text-2xl font-bold font-mono text-cyan-300">{offset.toFixed(0)}°</div>
              </div>
              <div className="rounded-lg border border-slate-800 bg-slate-950/50 px-3 py-3">
                <div className="text-[10px] uppercase tracking-wide text-slate-500">Sens actuel</div>
                <div className={`mt-1 text-sm font-bold ${inverted ? 'text-amber-300' : 'text-emerald-300'}`}>
                  {inverted ? 'Inversé' : 'Normal'}
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                disabled={!connected}
                className={`h-10 rounded-lg border flex items-center justify-center gap-1.5 text-xs disabled:opacity-40 ${
                  inverted
