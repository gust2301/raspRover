...
async def lifespan(app: FastAPI):
    ...
    _lidar_ros_adapter = _ROS2LidarAdapter(
        ...
        angle_offset_deg=float(ros2_cfg.get("angle_offset_deg", 0.0)),
    )
    ...
    _follow_me = (
        FollowMeController(
            ...
            target_distance_m=float(follow_cfg.get("target_distance_m", 0.75)),
            distance_deadband_m=float(follow_cfg.get("distance_deadband_m", 0.10)),
            minimum_motor_command=float(follow_cfg.get("minimum_motor_command", 0.14)),
            max_forward_speed=float(follow_cfg.get("max_forward_speed", 0.30)),
            max_turn_speed=float(follow_cfg.get("max_turn_speed", 0.30)),
